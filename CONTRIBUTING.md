# Contributing to postings

Thanks for your interest. postings is inverted-index postings lists with segment-style updates. Supports u32 TF (classical) and f32 weights (SPLADE/learned sparse).
...
- Commit messages: `postings: short lowercase description`. One commit per logical change.
